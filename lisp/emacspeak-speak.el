...
(defcustom emacspeak-audio-indentation-before "indent "
  "Option specifying the phrase that is spoken before the indent level,
      when speaking line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-after ""
  "Option specifying the phrase that is spoken after the indent level,
      when speaking line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-tab-grouped nil
  "Option indicating whether indentation levels should be
      grouped into a multiple of the tab-width and an offset,
      when speaking line indentation."
  :group 'emacspeak-speak
  :type 'boolean)

(defcustom emacspeak-audio-indentation-before-tab ""
  "Option specifying the phrase that is spoken before the tab-width multiple,
      when speaking tab-grouped line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-after-tab " tabs"
  "Option specifying the phrase that is spoken after the tab-width multiple,
      when speaking tab-grouped line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-tab-grouped-separator " "
  "Option specifying the phrase that is spoken
      between the tab-width multiple and the tab-width offset,
      when speaking tab-grouped line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-before-offset ""
  "Option specifying the phrase that is spoken before the tab-width offset,
      when speaking tab-grouped line indentation."
  :group 'emacspeak-speak
  :type 'string)

(defcustom emacspeak-audio-indentation-after-offset " spaces"
  "Option specifying the phrase that is spoken after the tab-width offset,
      when speaking tab-grouped line indentation."
  :group 'emacspeak-speak
  :type 'string)
...
(defvar emacspeak-version
  (concat "55.0,   " emacspeak-codename)
